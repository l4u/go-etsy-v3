...
// checks if the ShopRefundAmount type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShopRefundAmount{}

// ShopRefundAmount A number equal to the refund total.
type ShopRefundAmount struct {
...
func (o ShopRefundAmount) MarshalJSON() ([]byte, error) {
...
func (o ShopRefundAmount) ToMap() (map[string]interface{}, error) {
...
type NullableShopRefundAmount struct {
	value *ShopRefundAmount
	isSet bool
}

func (v NullableShopRefundAmount) Get() *ShopRefundAmount {
	return v.value
}

func (v *NullableShopRefundAmount) Set(val *ShopRefundAmount) {
	v.value = val
	v.isSet = true
}

func (v NullableShopRefundAmount) IsSet() bool {
	return v.isSet
}

func (v *NullableShopRefundAmount) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShopRefundAmount(val *ShopRefundAmount) *NullableShopRefundAmount {
	return &NullableShopRefundAmount{value: val, isSet: true}
}

func (v NullableShopRefundAmount) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShopRefundAmount) UnmarshalJSON(src []byte) error {
	v.isSet = true
