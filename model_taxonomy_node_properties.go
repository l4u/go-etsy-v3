...
type TaxonomyNodeProperties struct {
	...
	Results []TaxonomyNodePropertiesResultsInner `json:"results,omitempty"`
}
...
func (o *TaxonomyNodeProperties) GetResults() []TaxonomyNodePropertiesResultsInner {
	if o == nil || IsNil(o.Results) {
		var ret []TaxonomyNodePropertiesResultsInner
		return ret
	}
	return o.Results
}
...
// SetResults gets a reference to the given []TaxonomyNodePropertiesResultsInner and assigns it to the Results field.
