...
// checks if the ListingInventoryProductOfferingPrice type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListingInventoryProductOfferingPrice{}

// ListingInventoryProductOfferingPrice Price data for this ProductOffering
type ListingInventoryProductOfferingPrice struct {
...
func NewListingInventoryProductOfferingPrice() *ListingInventoryProductOfferingPrice {
	this := ListingInventoryProductOfferingPrice{}
	return &this
}
...
func (o ListingInventoryProductOfferingPrice) MarshalJSON() ([]byte, error) {
...
func (o ListingInventoryProductOfferingPrice) ToMap() (map[string]interface{}, error) {
...
type NullableListingInventoryProductOfferingPrice struct {
	value *ListingInventoryProductOfferingPrice
	isSet bool
}

func (v NullableListingInventoryProductOfferingPrice) Get() *ListingInventoryProductOfferingPrice {
	return v.value
}

func (v *NullableListingInventoryProductOfferingPrice) Set(val *ListingInventoryProductOfferingPrice) {
	v.value = val
	v.isSet = true
}

func (v NullableListingInventoryProductOfferingPrice) IsSet() bool {
	return v.isSet
}

func (v *NullableListingInventoryProductOfferingPrice) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListingInventoryProductOfferingPrice(val *ListingInventoryProductOfferingPrice) *NullableListingInventoryProductOfferingPrice {
	return &NullableListingInventoryProductOfferingPrice{value: val, isSet: true}
}

func (v NullableListingInventoryProductOfferingPrice) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListingInventoryProductOfferingPrice) UnmarshalJSON(src []byte) error {
	v.isSet = true
