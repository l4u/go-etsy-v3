...
// checks if the ShopReceiptTotalPrice type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShopReceiptTotalPrice{}

// ShopReceiptTotalPrice A number equal to the sum of the individual listings\\' (price * quantity). Does not included tax or shipping costs.
type ShopReceiptTotalPrice struct {
...
func (o ShopReceiptTotalPrice) MarshalJSON() ([]byte, error) {
...
func (o ShopReceiptTotalPrice) ToMap() (map[string]interface{}, error) {
...
type NullableShopReceiptTotalPrice struct {
	value *ShopReceiptTotalPrice
	isSet bool
}

func (v NullableShopReceiptTotalPrice) Get() *ShopReceiptTotalPrice {
	return v.value
}

func (v *NullableShopReceiptTotalPrice) Set(val *ShopReceiptTotalPrice) {
	v.value = val
	v.isSet = true
}

func (v NullableShopReceiptTotalPrice) IsSet() bool {
	return v.isSet
}

func (v *NullableShopReceiptTotalPrice) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShopReceiptTotalPrice(val *ShopReceiptTotalPrice) *NullableShopReceiptTotalPrice {
	return &NullableShopReceiptTotalPrice{value: val, isSet: true}
}

func (v NullableShopReceiptTotalPrice) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShopReceiptTotalPrice) UnmarshalJSON(src []byte) error {
	v.isSet = true
