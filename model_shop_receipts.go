...
type ShopReceipts struct {
	...
	Results []ShopReceiptsResultsInner `json:"results,omitempty"`
}
...
func (o *ShopReceipts) GetResults() []ShopReceiptsResultsInner {
	if o == nil || IsNil(o.Results) {
		var ret []ShopReceiptsResultsInner
		return ret
	}
	return o.Results
}
...
// SetResults gets a reference to the given []ShopReceiptsResultsInner and assigns it to the Results field.
