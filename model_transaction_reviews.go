...
type TransactionReviews struct {
	...
	Results []TransactionReviewsResultsInner `json:"results,omitempty"`
}
...
func (o *TransactionReviews) GetResults() []TransactionReviewsResultsInner {
	if o == nil || IsNil(o.Results) {
		var ret []TransactionReviewsResultsInner
		return ret
	}
	return o.Results
}
...
// SetResults gets a reference to the given []TransactionReviewsResultsInner and assigns it to the Results field.
