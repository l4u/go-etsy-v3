...
// checks if the ShopListingWithAssociationsShop type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShopListingWithAssociationsShop{}

// ShopListingWithAssociationsShop A shop created by an Etsy user.
type ShopListingWithAssociationsShop struct {
...
func NewShopListingWithAssociationsShop() *ShopListingWithAssociationsShop {
	this := ShopListingWithAssociationsShop{}
	return &this
}
...
func (o *ShopListingWithAssociationsShop) SetTitleNil() {
	o.Title.Set(nil)
}
...
func (o *ShopListingWithAssociationsShop) SetAnnouncementNil() {
...
func (o *ShopListingWithAssociationsShop) SetVacationMessageNil() {
...
func (o *ShopListingWithAssociationsShop) SetSaleMessageNil() {
...
func (o *ShopListingWithAssociationsShop) SetDigitalSaleMessageNil() {
...
func (o *ShopListingWithAssociationsShop) SetPolicyWelcomeNil() {
...
func (o *ShopListingWithAssociationsShop) SetPolicyPaymentNil() {
...
func (o *ShopListingWithAssociationsShop) SetPolicyShippingNil() {
...
func (o *ShopListingWithAssociationsShop) SetPolicyRefundsNil() {
...
func (o *ShopListingWithAssociationsShop) SetPolicyAdditionalNil() {
...
func (o *ShopListingWithAssociationsShop) SetPolicySellerInfoNil() {
...
func (o *ShopListingWithAssociationsShop) SetPolicyPrivacyNil() {
...
func (o *ShopListingWithAssociationsShop) SetVacationAutoreplyNil() {
...
func (o *ShopListingWithAssociationsShop) SetImageUrl760x100Nil() {
...
func (o *ShopListingWithAssociationsShop) SetIconUrlFullxfullNil() {
...
func (o *ShopListingWithAssociationsShop) SetShippingFromCountryIsoNil() {
...
func (o *ShopListingWithAssociationsShop) SetShopLocationCountryIsoNil() {
...
func (o *ShopListingWithAssociationsShop) SetReviewCountNil() {
...
func (o *ShopListingWithAssociationsShop) SetReviewAverageNil() {
...
func (o ShopListingWithAssociationsShop) MarshalJSON() ([]byte, error) {
...
func (o ShopListingWithAssociationsShop) ToMap() (map[string]interface{}, error) {
...
type NullableShopListingWithAssociationsShop struct {
	value *ShopListingWithAssociationsShop
	isSet bool
}

func (v NullableShopListingWithAssociationsShop) Get() *ShopListingWithAssociationsShop {
	return v.value
}

func (v *NullableShopListingWithAssociationsShop) Set(val *ShopListingWithAssociationsShop) {
	v.value = val
	v.isSet = true
}

func (v NullableShopListingWithAssociationsShop) IsSet() bool {
	return v.isSet
}

func (v *NullableShopListingWithAssociationsShop) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShopListingWithAssociationsShop(val *ShopListingWithAssociationsShop) *NullableShopListingWithAssociationsShop {
	return &NullableShopListingWithAssociationsShop{value: val, isSet: true}
}

func (v NullableShopListingWithAssociationsShop) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShopListingWithAssociationsShop) UnmarshalJSON(src []byte) error {
	v.isSet = true
