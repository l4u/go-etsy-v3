...
// checks if the ShopReceiptTotalShippingCost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShopReceiptTotalShippingCost{}

// ShopReceiptTotalShippingCost A number equal to the total shipping cost of the receipt.
type ShopReceiptTotalShippingCost struct {
...
func NewShopReceiptTotalShippingCost() *ShopReceiptTotalShippingCost {
	this := ShopReceiptTotalShippingCost{}
	return &this
}
...
func (o ShopReceiptTotalShippingCost) MarshalJSON() ([]byte, error) {
...
func (o ShopReceiptTotalShippingCost) ToMap() (map[string]interface{}, error) {
...
type NullableShopReceiptTotalShippingCost struct {
	value *ShopReceiptTotalShippingCost
	isSet bool
}

func (v NullableShopReceiptTotalShippingCost) Get() *ShopReceiptTotalShippingCost {
	return v.value
}

func (v *NullableShopReceiptTotalShippingCost) Set(val *ShopReceiptTotalShippingCost) {
	v.value = val
	v.isSet = true
}

func (v NullableShopReceiptTotalShippingCost) IsSet() bool {
	return v.isSet
}

func (v *NullableShopReceiptTotalShippingCost) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShopReceiptTotalShippingCost(val *ShopReceiptTotalShippingCost) *NullableShopReceiptTotalShippingCost {
	return &NullableShopReceiptTotalShippingCost{value: val, isSet: true}
}

func (v NullableShopReceiptTotalShippingCost) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShopReceiptTotalShippingCost) UnmarshalJSON(src []byte) error {
	v.isSet = true
