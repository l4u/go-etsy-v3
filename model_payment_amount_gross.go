...
// checks if the PaymentAmountGross type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaymentAmountGross{}

// PaymentAmountGross An integer equal to gross amount of the order, in pennies, including shipping and taxes.
type PaymentAmountGross struct {
...
func (o PaymentAmountGross) MarshalJSON() ([]byte, error) {
...
func (o PaymentAmountGross) ToMap() (map[string]interface{}, error) {
...
type NullablePaymentAmountGross struct {
	value *PaymentAmountGross
	isSet bool
}

func (v NullablePaymentAmountGross) Get() *PaymentAmountGross {
	return v.value
}

func (v *NullablePaymentAmountGross) Set(val *PaymentAmountGross) {
	v.value = val
	v.isSet = true
}

func (v NullablePaymentAmountGross) IsSet() bool {
	return v.isSet
}

func (v *NullablePaymentAmountGross) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaymentAmountGross(val *PaymentAmountGross) *NullablePaymentAmountGross {
	return &NullablePaymentAmountGross{value: val, isSet: true}
}

func (v NullablePaymentAmountGross) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaymentAmountGross) UnmarshalJSON(src []byte) error {
	v.isSet = true
