...
// checks if the TaxonomyNodePropertySelectedValuesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TaxonomyNodePropertySelectedValuesInner{}

// TaxonomyNodePropertySelectedValuesInner A list of property value strings automatically and always selected for the given property.
type TaxonomyNodePropertySelectedValuesInner struct {
...
func NewTaxonomyNodePropertySelectedValuesInner() *TaxonomyNodePropertySelectedValuesInner {
	this := TaxonomyNodePropertySelectedValuesInner{}
	return &this
}
...
func (o *TaxonomyNodePropertySelectedValuesInner) SetValueIdNil() {
	o.ValueId.Set(nil)
}
...
func (o *TaxonomyNodePropertySelectedValuesInner) SetScaleIdNil() {
	o.ScaleId.Set(nil)
}
...
func (o TaxonomyNodePropertySelectedValuesInner) MarshalJSON() ([]byte, error) {
...
func (o TaxonomyNodePropertySelectedValuesInner) ToMap() (map[string]interface{}, error) {
...
type NullableTaxonomyNodePropertySelectedValuesInner struct {
	value *TaxonomyNodePropertySelectedValuesInner
	isSet bool
}

func (v NullableTaxonomyNodePropertySelectedValuesInner) Get() *TaxonomyNodePropertySelectedValuesInner {
	return v.value
}

func (v *NullableTaxonomyNodePropertySelectedValuesInner) Set(val *TaxonomyNodePropertySelectedValuesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableTaxonomyNodePropertySelectedValuesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableTaxonomyNodePropertySelectedValuesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTaxonomyNodePropertySelectedValuesInner(val *TaxonomyNodePropertySelectedValuesInner) *NullableTaxonomyNodePropertySelectedValuesInner {
	return &NullableTaxonomyNodePropertySelectedValuesInner{value: val, isSet: true}
}

func (v NullableTaxonomyNodePropertySelectedValuesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTaxonomyNodePropertySelectedValuesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
