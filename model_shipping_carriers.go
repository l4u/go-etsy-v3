...
type ShippingCarriers struct {
	...
	Results []ShippingCarriersResultsInner `json:"results,omitempty"`
}
...
func (o *ShippingCarriers) GetResults() []ShippingCarriersResultsInner {
	if o == nil || IsNil(o.Results) {
		var ret []ShippingCarriersResultsInner
		return ret
	}
	return o.Results
}
...
// SetResults gets a reference to the given []ShippingCarriersResultsInner and assigns it to the Results field.
