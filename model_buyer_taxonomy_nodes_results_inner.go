...
// checks if the BuyerTaxonomyNodesResultsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BuyerTaxonomyNodesResultsInner{}

// BuyerTaxonomyNodesResultsInner The list of requested resources.
type BuyerTaxonomyNodesResultsInner struct {
...
func NewBuyerTaxonomyNodesResultsInner() *BuyerTaxonomyNodesResultsInner {
	this := BuyerTaxonomyNodesResultsInner{}
	return &this
}
...
func (o *BuyerTaxonomyNodesResultsInner) SetParentIdNil() {
	o.ParentId.Set(nil)
}
...
func (o BuyerTaxonomyNodesResultsInner) MarshalJSON() ([]byte, error) {
...
func (o BuyerTaxonomyNodesResultsInner) ToMap() (map[string]interface{}, error) {
...
type NullableBuyerTaxonomyNodesResultsInner struct {
	value *BuyerTaxonomyNodesResultsInner
	isSet bool
}

func (v NullableBuyerTaxonomyNodesResultsInner) Get() *BuyerTaxonomyNodesResultsInner {
	return v.value
}

func (v *NullableBuyerTaxonomyNodesResultsInner) Set(val *BuyerTaxonomyNodesResultsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableBuyerTaxonomyNodesResultsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableBuyerTaxonomyNodesResultsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBuyerTaxonomyNodesResultsInner(val *BuyerTaxonomyNodesResultsInner) *NullableBuyerTaxonomyNodesResultsInner {
	return &NullableBuyerTaxonomyNodesResultsInner{value: val, isSet: true}
}

func (v NullableBuyerTaxonomyNodesResultsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBuyerTaxonomyNodesResultsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
