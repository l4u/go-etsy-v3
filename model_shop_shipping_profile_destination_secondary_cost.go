...
// checks if the ShopShippingProfileDestinationSecondaryCost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShopShippingProfileDestinationSecondaryCost{}

// ShopShippingProfileDestinationSecondaryCost The cost of shipping to this country/region with another item, measured in the store's default currency.
type ShopShippingProfileDestinationSecondaryCost struct {
...
func NewShopShippingProfileDestinationSecondaryCost() *ShopShippingProfileDestinationSecondaryCost {
	this := ShopShippingProfileDestinationSecondaryCost{}
	return &this
}
...
func (o ShopShippingProfileDestinationSecondaryCost) MarshalJSON() ([]byte, error) {
...
func (o ShopShippingProfileDestinationSecondaryCost) ToMap() (map[string]interface{}, error) {
...
type NullableShopShippingProfileDestinationSecondaryCost struct {
	value *ShopShippingProfileDestinationSecondaryCost
	isSet bool
}

func (v NullableShopShippingProfileDestinationSecondaryCost) Get() *ShopShippingProfileDestinationSecondaryCost {
	return v.value
}

func (v *NullableShopShippingProfileDestinationSecondaryCost) Set(val *ShopShippingProfileDestinationSecondaryCost) {
	v.value = val
	v.isSet = true
}

func (v NullableShopShippingProfileDestinationSecondaryCost) IsSet() bool {
	return v.isSet
}

func (v *NullableShopShippingProfileDestinationSecondaryCost) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShopShippingProfileDestinationSecondaryCost(val *ShopShippingProfileDestinationSecondaryCost) *NullableShopShippingProfileDestinationSecondaryCost {
	return &NullableShopShippingProfileDestinationSecondaryCost{value: val, isSet: true}
}

func (v NullableShopShippingProfileDestinationSecondaryCost) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShopShippingProfileDestinationSecondaryCost) UnmarshalJSON(src []byte) error {
	v.isSet = true
