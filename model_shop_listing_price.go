...
// checks if the ShopListingPrice type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShopListingPrice{}

// ShopListingPrice The positive non-zero price of the product. (Sold product listings are private) Note: The price is the minimum possible price. The [`getListingInventory`](/documentation/reference/#operation/getListingInventory) method requests exact prices for available offerings.
type ShopListingPrice struct {
...
func (o ShopListingPrice) MarshalJSON() ([]byte, error) {
...
func (o ShopListingPrice) ToMap() (map[string]interface{}, error) {
...
type NullableShopListingPrice struct {
	value *ShopListingPrice
	isSet bool
}

func (v NullableShopListingPrice) Get() *ShopListingPrice {
	return v.value
}

func (v *NullableShopListingPrice) Set(val *ShopListingPrice) {
	v.value = val
	v.isSet = true
}

func (v NullableShopListingPrice) IsSet() bool {
	return v.isSet
}

func (v *NullableShopListingPrice) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShopListingPrice(val *ShopListingPrice) *NullableShopListingPrice {
	return &NullableShopListingPrice{value: val, isSet: true}
}

func (v NullableShopListingPrice) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShopListingPrice) UnmarshalJSON(src []byte) error {
	v.isSet = true
