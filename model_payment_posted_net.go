...
// checks if the PaymentPostedNet type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaymentPostedNet{}

// PaymentPostedNet The total value of the payment at the time of posting, less fees. (`posted_gross` - `posted_fees`)
type PaymentPostedNet struct {
...
func (o PaymentPostedNet) MarshalJSON() ([]byte, error) {
...
func (o PaymentPostedNet) ToMap() (map[string]interface{}, error) {
...
type NullablePaymentPostedNet struct {
	value *PaymentPostedNet
	isSet bool
}

func (v NullablePaymentPostedNet) Get() *PaymentPostedNet {
	return v.value
}

func (v *NullablePaymentPostedNet) Set(val *PaymentPostedNet) {
	v.value = val
	v.isSet = true
}

func (v NullablePaymentPostedNet) IsSet() bool {
	return v.isSet
}

func (v *NullablePaymentPostedNet) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaymentPostedNet(val *PaymentPostedNet) *NullablePaymentPostedNet {
	return &NullablePaymentPostedNet{value: val, isSet: true}
}

func (v NullablePaymentPostedNet) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaymentPostedNet) UnmarshalJSON(src []byte) error {
	v.isSet = true
