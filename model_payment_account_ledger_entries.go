...
type PaymentAccountLedgerEntries struct {
	...
	Results []PaymentAccountLedgerEntriesResultsInner `json:"results,omitempty"`
}
...
func (o *PaymentAccountLedgerEntries) GetResults() []PaymentAccountLedgerEntriesResultsInner {
	if o == nil || IsNil(o.Results) {
		var ret []PaymentAccountLedgerEntriesResultsInner
		return ret
	}
	return o.Results
}
...
// SetResults gets a reference to the given []PaymentAccountLedgerEntriesResultsInner and assigns it to the Results field.
