...
// checks if the ShopReturnPoliciesResultsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShopReturnPoliciesResultsInner{}

// ShopReturnPoliciesResultsInner struct for ShopReturnPoliciesResultsInner
type ShopReturnPoliciesResultsInner struct {
...
func NewShopReturnPoliciesResultsInner() *ShopReturnPoliciesResultsInner {
	this := ShopReturnPoliciesResultsInner{}
	return &this
}
...
func (o *ShopReturnPoliciesResultsInner) SetReturnDeadlineNil() {
...
func (o ShopReturnPoliciesResultsInner) MarshalJSON() ([]byte, error) {
...
func (o ShopReturnPoliciesResultsInner) ToMap() (map[string]interface{}, error) {
...
type NullableShopReturnPoliciesResultsInner struct {
	value *ShopReturnPoliciesResultsInner
	isSet bool
}

func (v NullableShopReturnPoliciesResultsInner) Get() *ShopReturnPoliciesResultsInner {
	return v.value
}

func (v *NullableShopReturnPoliciesResultsInner) Set(val *ShopReturnPoliciesResultsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableShopReturnPoliciesResultsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableShopReturnPoliciesResultsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShopReturnPoliciesResultsInner(val *ShopReturnPoliciesResultsInner) *NullableShopReturnPoliciesResultsInner {
	return &NullableShopReturnPoliciesResultsInner{value: val, isSet: true}
}

func (v NullableShopReturnPoliciesResultsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShopReturnPoliciesResultsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
