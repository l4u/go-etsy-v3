...
// checks if the ListingPropertyValuesResultsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListingPropertyValuesResultsInner{}

// ListingPropertyValuesResultsInner struct for ListingPropertyValuesResultsInner
type ListingPropertyValuesResultsInner struct {
...
func NewListingPropertyValuesResultsInner() *ListingPropertyValuesResultsInner {
	this := ListingPropertyValuesResultsInner{}
	return &this
}
...
func (o *ListingPropertyValuesResultsInner) SetPropertyNameNil() {
...
func (o *ListingPropertyValuesResultsInner) SetScaleIdNil() {
	o.ScaleId.Set(nil)
}
...
func (o *ListingPropertyValuesResultsInner) SetScaleNameNil() {
	o.ScaleName.Set(nil)
}
...
func (o ListingPropertyValuesResultsInner) MarshalJSON() ([]byte, error) {
...
func (o ListingPropertyValuesResultsInner) ToMap() (map[string]interface{}, error) {
...
type NullableListingPropertyValuesResultsInner struct {
	value *ListingPropertyValuesResultsInner
	isSet bool
}

func (v NullableListingPropertyValuesResultsInner) Get() *ListingPropertyValuesResultsInner {
	return v.value
}

func (v *NullableListingPropertyValuesResultsInner) Set(val *ListingPropertyValuesResultsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableListingPropertyValuesResultsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableListingPropertyValuesResultsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListingPropertyValuesResultsInner(val *ListingPropertyValuesResultsInner) *NullableListingPropertyValuesResultsInner {
	return &NullableListingPropertyValuesResultsInner{value: val, isSet: true}
}

func (v NullableListingPropertyValuesResultsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListingPropertyValuesResultsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
