...
type Shops struct {
	...
	// The Shop resources.
	Results []ShopsResultsInner `json:"results,omitempty"`
}
...
// SetResults gets a reference to the given []ShopsResultsInner and assigns it to the Results field.
