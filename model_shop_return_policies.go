...
type ShopReturnPolicies struct {
	...
	Results []ShopReturnPoliciesResultsInner `json:"results,omitempty"`
}
...
func (o *ShopReturnPolicies) GetResults() []ShopReturnPoliciesResultsInner {
	if o == nil || IsNil(o.Results) {
		var ret []ShopReturnPoliciesResultsInner
		return ret
	}
	return o.Results
}
...
// SetResults gets a reference to the given []ShopReturnPoliciesResultsInner and assigns it to the Results field.
