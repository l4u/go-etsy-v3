...
type ShopReceiptTransactions struct {
	...
	Results []ShopReceiptTransactionsResultsInner `json:"results,omitempty"`
}
...
func (o *ShopReceiptTransactions) GetResults() []ShopReceiptTransactionsResultsInner {
	if o == nil || IsNil(o.Results) {
		var ret []ShopReceiptTransactionsResultsInner
		return ret
	}
	return o.Results
}
...
// SetResults gets a reference to the given []ShopReceiptTransactionsResultsInner and assigns it to the Results field.
