...
// checks if the ShopShippingProfileUpgradeSecondaryPrice type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShopShippingProfileUpgradeSecondaryPrice{}

// ShopShippingProfileUpgradeSecondaryPrice Additional cost of adding the shipping upgrade for each additional item.
type ShopShippingProfileUpgradeSecondaryPrice struct {
...
func NewShopShippingProfileUpgradeSecondaryPrice() *ShopShippingProfileUpgradeSecondaryPrice {
	this := ShopShippingProfileUpgradeSecondaryPrice{}
	return &this
}
...
func (o ShopShippingProfileUpgradeSecondaryPrice) MarshalJSON() ([]byte, error) {
...
func (o ShopShippingProfileUpgradeSecondaryPrice) ToMap() (map[string]interface{}, error) {
...
type NullableShopShippingProfileUpgradeSecondaryPrice struct {
	value *ShopShippingProfileUpgradeSecondaryPrice
	isSet bool
}

func (v NullableShopShippingProfileUpgradeSecondaryPrice) Get() *ShopShippingProfileUpgradeSecondaryPrice {
	return v.value
}

func (v *NullableShopShippingProfileUpgradeSecondaryPrice) Set(val *ShopShippingProfileUpgradeSecondaryPrice) {
	v.value = val
	v.isSet = true
}

func (v NullableShopShippingProfileUpgradeSecondaryPrice) IsSet() bool {
	return v.isSet
}

func (v *NullableShopShippingProfileUpgradeSecondaryPrice) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShopShippingProfileUpgradeSecondaryPrice(val *ShopShippingProfileUpgradeSecondaryPrice) *NullableShopShippingProfileUpgradeSecondaryPrice {
	return &NullableShopShippingProfileUpgradeSecondaryPrice{value: val, isSet: true}
}

func (v NullableShopShippingProfileUpgradeSecondaryPrice) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShopShippingProfileUpgradeSecondaryPrice) UnmarshalJSON(src []byte) error {
	v.isSet = true
