...
// checks if the ShopReceiptTransactionPrice type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShopReceiptTransactionPrice{}

// ShopReceiptTransactionPrice A money object representing the price recorded the transaction.
type ShopReceiptTransactionPrice struct {
...
func NewShopReceiptTransactionPrice() *ShopReceiptTransactionPrice {
	this := ShopReceiptTransactionPrice{}
	return &this
}
...
func (o ShopReceiptTransactionPrice) MarshalJSON() ([]byte, error) {
...
func (o ShopReceiptTransactionPrice) ToMap() (map[string]interface{}, error) {
...
type NullableShopReceiptTransactionPrice struct {
	value *ShopReceiptTransactionPrice
	isSet bool
}

func (v NullableShopReceiptTransactionPrice) Get() *ShopReceiptTransactionPrice {
	return v.value
}

func (v *NullableShopReceiptTransactionPrice) Set(val *ShopReceiptTransactionPrice) {
	v.value = val
	v.isSet = true
}

func (v NullableShopReceiptTransactionPrice) IsSet() bool {
	return v.isSet
}

func (v *NullableShopReceiptTransactionPrice) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShopReceiptTransactionPrice(val *ShopReceiptTransactionPrice) *NullableShopReceiptTransactionPrice {
	return &NullableShopReceiptTransactionPrice{value: val, isSet: true}
}

func (v NullableShopReceiptTransactionPrice) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShopReceiptTransactionPrice) UnmarshalJSON(src []byte) error {
	v.isSet = true
