...
type ListingVariationImages struct {
	...
	Results []ListingVariationImagesResultsInner `json:"results,omitempty"`
}
...
func (o *ListingVariationImages) GetResults() []ListingVariationImagesResultsInner {
	if o == nil || IsNil(o.Results) {
		var ret []ListingVariationImagesResultsInner
		return ret
	}
	return o.Results
}
...
// SetResults gets a reference to the given []ListingVariationImagesResultsInner and assigns it to the Results field.
