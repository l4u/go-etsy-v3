...
// checks if the PaymentAmountNet type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaymentAmountNet{}

// PaymentAmountNet An integer equal to the payment value, in pennies, less fees (`amount_gross` - `amount_fees`).
type PaymentAmountNet struct {
...
func (o PaymentAmountNet) MarshalJSON() ([]byte, error) {
...
func (o PaymentAmountNet) ToMap() (map[string]interface{}, error) {
...
type NullablePaymentAmountNet struct {
	value *PaymentAmountNet
	isSet bool
}

func (v NullablePaymentAmountNet) Get() *PaymentAmountNet {
	return v.value
}

func (v *NullablePaymentAmountNet) Set(val *PaymentAmountNet) {
	v.value = val
	v.isSet = true
}

func (v NullablePaymentAmountNet) IsSet() bool {
	return v.isSet
}

func (v *NullablePaymentAmountNet) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaymentAmountNet(val *PaymentAmountNet) *NullablePaymentAmountNet {
	return &NullablePaymentAmountNet{value: val, isSet: true}
}

func (v NullablePaymentAmountNet) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaymentAmountNet) UnmarshalJSON(src []byte) error {
	v.isSet = true
