...
// checks if the ShopReceiptGiftWrapPrice type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShopReceiptGiftWrapPrice{}

// ShopReceiptGiftWrapPrice The numeric price of gift wrap for this receipt.
type ShopReceiptGiftWrapPrice struct {
...
func (o ShopReceiptGiftWrapPrice) MarshalJSON() ([]byte, error) {
...
func (o ShopReceiptGiftWrapPrice) ToMap() (map[string]interface{}, error) {
...
type NullableShopReceiptGiftWrapPrice struct {
	value *ShopReceiptGiftWrapPrice
	isSet bool
}

func (v NullableShopReceiptGiftWrapPrice) Get() *ShopReceiptGiftWrapPrice {
	return v.value
}

func (v *NullableShopReceiptGiftWrapPrice) Set(val *ShopReceiptGiftWrapPrice) {
	v.value = val
	v.isSet = true
}

func (v NullableShopReceiptGiftWrapPrice) IsSet() bool {
	return v.isSet
}

func (v *NullableShopReceiptGiftWrapPrice) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShopReceiptGiftWrapPrice(val *ShopReceiptGiftWrapPrice) *NullableShopReceiptGiftWrapPrice {
	return &NullableShopReceiptGiftWrapPrice{value: val, isSet: true}
}

func (v NullableShopReceiptGiftWrapPrice) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShopReceiptGiftWrapPrice) UnmarshalJSON(src []byte) error {
	v.isSet = true
