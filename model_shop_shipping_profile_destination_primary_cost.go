...
// checks if the ShopShippingProfileDestinationPrimaryCost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShopShippingProfileDestinationPrimaryCost{}

// ShopShippingProfileDestinationPrimaryCost The cost of shipping to this country/region alone, measured in the store's default currency.
type ShopShippingProfileDestinationPrimaryCost struct {
...
func NewShopShippingProfileDestinationPrimaryCost() *ShopShippingProfileDestinationPrimaryCost {
	this := ShopShippingProfileDestinationPrimaryCost{}
	return &this
}
...
func (o ShopShippingProfileDestinationPrimaryCost) MarshalJSON() ([]byte, error) {
...
func (o ShopShippingProfileDestinationPrimaryCost) ToMap() (map[string]interface{}, error) {
...
type NullableShopShippingProfileDestinationPrimaryCost struct {
	value *ShopShippingProfileDestinationPrimaryCost
	isSet bool
}

func (v NullableShopShippingProfileDestinationPrimaryCost) Get() *ShopShippingProfileDestinationPrimaryCost {
	return v.value
}

func (v *NullableShopShippingProfileDestinationPrimaryCost) Set(val *ShopShippingProfileDestinationPrimaryCost) {
	v.value = val
	v.isSet = true
}

func (v NullableShopShippingProfileDestinationPrimaryCost) IsSet() bool {
	return v.isSet
}

func (v *NullableShopShippingProfileDestinationPrimaryCost) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShopShippingProfileDestinationPrimaryCost(val *ShopShippingProfileDestinationPrimaryCost) *NullableShopShippingProfileDestinationPrimaryCost {
	return &NullableShopShippingProfileDestinationPrimaryCost{value: val, isSet: true}
}

func (v NullableShopShippingProfileDestinationPrimaryCost) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShopShippingProfileDestinationPrimaryCost) UnmarshalJSON(src []byte) error {
	v.isSet = true
