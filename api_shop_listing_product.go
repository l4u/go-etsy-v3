...
type ApiGetListingProductRequest struct {
	ctx context.Context
	ApiService *ShopListingProductApiService
	listingId int32
	productId int32
}

func (r ApiGetListingProductRequest) Execute() (*ListingInventoryProduct, *http.Response, error) {
...
Open API V3 endpoint to retrieve a ListingProduct by ID.
 ...
 @return ApiGetListingProductRequest
*/
func (a *ShopListingProductApiService) GetListingProduct(ctx context.Context, listingId int32, productId int32) ApiGetListingProductRequest {
	return ApiGetListingProductRequest{
		ApiService: a,
		ctx: ctx,
		listingId: listingId,
...
func (a *ShopListingProductApiService) GetListingProductExecute(r ApiGetListingProductRequest) (*ListingInventoryProduct, *http.Response, error) {
	var (
