...
// checks if the BuyerTaxonomyNodePropertyPossibleValuesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BuyerTaxonomyNodePropertyPossibleValuesInner{}

// BuyerTaxonomyNodePropertyPossibleValuesInner A list of supported property value strings for this property.
type BuyerTaxonomyNodePropertyPossibleValuesInner struct {
...
func NewBuyerTaxonomyNodePropertyPossibleValuesInner() *BuyerTaxonomyNodePropertyPossibleValuesInner {
	this := BuyerTaxonomyNodePropertyPossibleValuesInner{}
	return &this
}
...
func (o *BuyerTaxonomyNodePropertyPossibleValuesInner) SetValueIdNil() {
	o.ValueId.Set(nil)
}
...
func (o *BuyerTaxonomyNodePropertyPossibleValuesInner) SetScaleIdNil() {
	o.ScaleId.Set(nil)
}
...
func (o BuyerTaxonomyNodePropertyPossibleValuesInner) MarshalJSON() ([]byte, error) {
...
func (o BuyerTaxonomyNodePropertyPossibleValuesInner) ToMap() (map[string]interface{}, error) {
...
type NullableBuyerTaxonomyNodePropertyPossibleValuesInner struct {
	value *BuyerTaxonomyNodePropertyPossibleValuesInner
	isSet bool
}

func (v NullableBuyerTaxonomyNodePropertyPossibleValuesInner) Get() *BuyerTaxonomyNodePropertyPossibleValuesInner {
	return v.value
}

func (v *NullableBuyerTaxonomyNodePropertyPossibleValuesInner) Set(val *BuyerTaxonomyNodePropertyPossibleValuesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableBuyerTaxonomyNodePropertyPossibleValuesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableBuyerTaxonomyNodePropertyPossibleValuesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBuyerTaxonomyNodePropertyPossibleValuesInner(val *BuyerTaxonomyNodePropertyPossibleValuesInner) *NullableBuyerTaxonomyNodePropertyPossibleValuesInner {
	return &NullableBuyerTaxonomyNodePropertyPossibleValuesInner{value: val, isSet: true}
}

func (v NullableBuyerTaxonomyNodePropertyPossibleValuesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBuyerTaxonomyNodePropertyPossibleValuesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
