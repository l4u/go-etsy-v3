...
// checks if the ShopReceiptTotalTaxCost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShopReceiptTotalTaxCost{}

// ShopReceiptTotalTaxCost The total sales tax of the receipt.
type ShopReceiptTotalTaxCost struct {
...
func (o ShopReceiptTotalTaxCost) MarshalJSON() ([]byte, error) {
...
func (o ShopReceiptTotalTaxCost) ToMap() (map[string]interface{}, error) {
...
type NullableShopReceiptTotalTaxCost struct {
	value *ShopReceiptTotalTaxCost
	isSet bool
}

func (v NullableShopReceiptTotalTaxCost) Get() *ShopReceiptTotalTaxCost {
	return v.value
}

func (v *NullableShopReceiptTotalTaxCost) Set(val *ShopReceiptTotalTaxCost) {
	v.value = val
	v.isSet = true
}

func (v NullableShopReceiptTotalTaxCost) IsSet() bool {
	return v.isSet
}

func (v *NullableShopReceiptTotalTaxCost) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShopReceiptTotalTaxCost(val *ShopReceiptTotalTaxCost) *NullableShopReceiptTotalTaxCost {
	return &NullableShopReceiptTotalTaxCost{value: val, isSet: true}
}

func (v NullableShopReceiptTotalTaxCost) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShopReceiptTotalTaxCost) UnmarshalJSON(src []byte) error {
	v.isSet = true
