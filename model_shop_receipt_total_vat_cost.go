...
// checks if the ShopReceiptTotalVatCost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShopReceiptTotalVatCost{}

// ShopReceiptTotalVatCost A number equal to the total value-added tax (VAT) of the receipt.
type ShopReceiptTotalVatCost struct {
...
func (o ShopReceiptTotalVatCost) MarshalJSON() ([]byte, error) {
...
func (o ShopReceiptTotalVatCost) ToMap() (map[string]interface{}, error) {
...
type NullableShopReceiptTotalVatCost struct {
	value *ShopReceiptTotalVatCost
	isSet bool
}

func (v NullableShopReceiptTotalVatCost) Get() *ShopReceiptTotalVatCost {
	return v.value
}

func (v *NullableShopReceiptTotalVatCost) Set(val *ShopReceiptTotalVatCost) {
	v.value = val
	v.isSet = true
}

func (v NullableShopReceiptTotalVatCost) IsSet() bool {
	return v.isSet
}

func (v *NullableShopReceiptTotalVatCost) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShopReceiptTotalVatCost(val *ShopReceiptTotalVatCost) *NullableShopReceiptTotalVatCost {
	return &NullableShopReceiptTotalVatCost{value: val, isSet: true}
}

func (v NullableShopReceiptTotalVatCost) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShopReceiptTotalVatCost) UnmarshalJSON(src []byte) error {
	v.isSet = true
