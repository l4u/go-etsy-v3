...
// checks if the PaymentsResultsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaymentsResultsInner{}

// PaymentsResultsInner A list of payments.
type PaymentsResultsInner struct {
...
func (o *PaymentsResultsInner) SetShopCurrencyNil() {
...
func (o *PaymentsResultsInner) SetBuyerCurrencyNil() {
...
func (o *PaymentsResultsInner) SetShippingUserIdNil() {
...
func (o *PaymentsResultsInner) SetShippedTimestampNil() {
...
func (o PaymentsResultsInner) MarshalJSON() ([]byte, error) {
...
func (o PaymentsResultsInner) ToMap() (map[string]interface{}, error) {
...
type NullablePaymentsResultsInner struct {
	value *PaymentsResultsInner
	isSet bool
}

func (v NullablePaymentsResultsInner) Get() *PaymentsResultsInner {
	return v.value
}

func (v *NullablePaymentsResultsInner) Set(val *PaymentsResultsInner) {
	v.value = val
	v.isSet = true
}

func (v NullablePaymentsResultsInner) IsSet() bool {
	return v.isSet
}

func (v *NullablePaymentsResultsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaymentsResultsInner(val *PaymentsResultsInner) *NullablePaymentsResultsInner {
	return &NullablePaymentsResultsInner{value: val, isSet: true}
}

func (v NullablePaymentsResultsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaymentsResultsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
