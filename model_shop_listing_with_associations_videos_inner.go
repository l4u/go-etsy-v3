...
// checks if the ShopListingWithAssociationsVideosInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShopListingWithAssociationsVideosInner{}

// ShopListingWithAssociationsVideosInner The single video associated with a listing.
type ShopListingWithAssociationsVideosInner struct {
...
func NewShopListingWithAssociationsVideosInner() *ShopListingWithAssociationsVideosInner {
	this := ShopListingWithAssociationsVideosInner{}
	return &this
}
...
func (o ShopListingWithAssociationsVideosInner) MarshalJSON() ([]byte, error) {
...
func (o ShopListingWithAssociationsVideosInner) ToMap() (map[string]interface{}, error) {
...
type NullableShopListingWithAssociationsVideosInner struct {
	value *ShopListingWithAssociationsVideosInner
	isSet bool
}

func (v NullableShopListingWithAssociationsVideosInner) Get() *ShopListingWithAssociationsVideosInner {
	return v.value
}

func (v *NullableShopListingWithAssociationsVideosInner) Set(val *ShopListingWithAssociationsVideosInner) {
	v.value = val
	v.isSet = true
}

func (v NullableShopListingWithAssociationsVideosInner) IsSet() bool {
	return v.isSet
}

func (v *NullableShopListingWithAssociationsVideosInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShopListingWithAssociationsVideosInner(val *ShopListingWithAssociationsVideosInner) *NullableShopListingWithAssociationsVideosInner {
	return &NullableShopListingWithAssociationsVideosInner{value: val, isSet: true}
}

func (v NullableShopListingWithAssociationsVideosInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShopListingWithAssociationsVideosInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
