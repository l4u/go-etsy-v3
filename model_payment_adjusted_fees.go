...
// checks if the PaymentAdjustedFees type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaymentAdjustedFees{}

// PaymentAdjustedFees The new fee amount after a seller refunds a payment, partially or fully.
type PaymentAdjustedFees struct {
...
func (o PaymentAdjustedFees) MarshalJSON() ([]byte, error) {
...
func (o PaymentAdjustedFees) ToMap() (map[string]interface{}, error) {
...
type NullablePaymentAdjustedFees struct {
	value *PaymentAdjustedFees
	isSet bool
}

func (v NullablePaymentAdjustedFees) Get() *PaymentAdjustedFees {
	return v.value
}

func (v *NullablePaymentAdjustedFees) Set(val *PaymentAdjustedFees) {
	v.value = val
	v.isSet = true
}

func (v NullablePaymentAdjustedFees) IsSet() bool {
	return v.isSet
}

func (v *NullablePaymentAdjustedFees) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaymentAdjustedFees(val *PaymentAdjustedFees) *NullablePaymentAdjustedFees {
	return &NullablePaymentAdjustedFees{value: val, isSet: true}
}

func (v NullablePaymentAdjustedFees) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaymentAdjustedFees) UnmarshalJSON(src []byte) error {
	v.isSet = true
