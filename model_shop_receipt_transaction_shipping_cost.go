...
// checks if the ShopReceiptTransactionShippingCost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShopReceiptTransactionShippingCost{}

// ShopReceiptTransactionShippingCost A money object representing the shipping cost for this transaction.
type ShopReceiptTransactionShippingCost struct {
...
func NewShopReceiptTransactionShippingCost() *ShopReceiptTransactionShippingCost {
	this := ShopReceiptTransactionShippingCost{}
	return &this
}
...
func (o ShopReceiptTransactionShippingCost) MarshalJSON() ([]byte, error) {
...
func (o ShopReceiptTransactionShippingCost) ToMap() (map[string]interface{}, error) {
...
type NullableShopReceiptTransactionShippingCost struct {
	value *ShopReceiptTransactionShippingCost
	isSet bool
}

func (v NullableShopReceiptTransactionShippingCost) Get() *ShopReceiptTransactionShippingCost {
	return v.value
}

func (v *NullableShopReceiptTransactionShippingCost) Set(val *ShopReceiptTransactionShippingCost) {
	v.value = val
	v.isSet = true
}

func (v NullableShopReceiptTransactionShippingCost) IsSet() bool {
	return v.isSet
}

func (v *NullableShopReceiptTransactionShippingCost) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShopReceiptTransactionShippingCost(val *ShopReceiptTransactionShippingCost) *NullableShopReceiptTransactionShippingCost {
	return &NullableShopReceiptTransactionShippingCost{value: val, isSet: true}
}

func (v NullableShopReceiptTransactionShippingCost) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShopReceiptTransactionShippingCost) UnmarshalJSON(src []byte) error {
	v.isSet = true
