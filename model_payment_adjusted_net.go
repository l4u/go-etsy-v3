...
// checks if the PaymentAdjustedNet type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaymentAdjustedNet{}

// PaymentAdjustedNet The total value of the payment after refunds, less fees (`adjusted_gross` - `adjusted_fees`).
type PaymentAdjustedNet struct {
...
func (o PaymentAdjustedNet) MarshalJSON() ([]byte, error) {
...
func (o PaymentAdjustedNet) ToMap() (map[string]interface{}, error) {
...
type NullablePaymentAdjustedNet struct {
	value *PaymentAdjustedNet
	isSet bool
}

func (v NullablePaymentAdjustedNet) Get() *PaymentAdjustedNet {
	return v.value
}

func (v *NullablePaymentAdjustedNet) Set(val *PaymentAdjustedNet) {
	v.value = val
	v.isSet = true
}

func (v NullablePaymentAdjustedNet) IsSet() bool {
	return v.isSet
}

func (v *NullablePaymentAdjustedNet) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaymentAdjustedNet(val *PaymentAdjustedNet) *NullablePaymentAdjustedNet {
	return &NullablePaymentAdjustedNet{value: val, isSet: true}
}

func (v NullablePaymentAdjustedNet) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaymentAdjustedNet) UnmarshalJSON(src []byte) error {
	v.isSet = true
