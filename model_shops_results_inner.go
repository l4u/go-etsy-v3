...
// checks if the ShopsResultsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShopsResultsInner{}

// ShopsResultsInner The Shop resources.
type ShopsResultsInner struct {
...
func (o *ShopsResultsInner) SetTitleNil() {
	o.Title.Set(nil)
}
...
func (o *ShopsResultsInner) SetAnnouncementNil() {
...
func (o *ShopsResultsInner) SetVacationMessageNil() {
...
func (o *ShopsResultsInner) SetSaleMessageNil() {
...
func (o *ShopsResultsInner) SetDigitalSaleMessageNil() {
...
func (o *ShopsResultsInner) SetPolicyWelcomeNil() {
...
func (o *ShopsResultsInner) SetPolicyPaymentNil() {
...
func (o *ShopsResultsInner) SetPolicyShippingNil() {
...
func (o *ShopsResultsInner) SetPolicyRefundsNil() {
...
func (o *ShopsResultsInner) SetPolicyAdditionalNil() {
...
func (o *ShopsResultsInner) SetPolicySellerInfoNil() {
...
func (o *ShopsResultsInner) SetPolicyPrivacyNil() {
...
func (o *ShopsResultsInner) SetVacationAutoreplyNil() {
...
func (o *ShopsResultsInner) SetImageUrl760x100Nil() {
...
func (o *ShopsResultsInner) SetIconUrlFullxfullNil() {
...
func (o *ShopsResultsInner) SetShippingFromCountryIsoNil() {
...
func (o *ShopsResultsInner) SetShopLocationCountryIsoNil() {
...
func (o *ShopsResultsInner) SetReviewCountNil() {
...
func (o *ShopsResultsInner) SetReviewAverageNil() {
...
func (o ShopsResultsInner) MarshalJSON() ([]byte, error) {
...
func (o ShopsResultsInner) ToMap() (map[string]interface{}, error) {
...
type NullableShopsResultsInner struct {
	value *ShopsResultsInner
	isSet bool
}

func (v NullableShopsResultsInner) Get() *ShopsResultsInner {
	return v.value
}

func (v *NullableShopsResultsInner) Set(val *ShopsResultsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableShopsResultsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableShopsResultsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShopsResultsInner(val *ShopsResultsInner) *NullableShopsResultsInner {
	return &NullableShopsResultsInner{value: val, isSet: true}
}

func (v NullableShopsResultsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShopsResultsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
