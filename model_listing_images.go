...
type ListingImages struct {
	...
	Results []ListingImagesResultsInner `json:"results,omitempty"`
}
...
func (o *ListingImages) GetResults() []ListingImagesResultsInner {
	if o == nil || IsNil(o.Results) {
		var ret []ListingImagesResultsInner
		return ret
	}
	return o.Results
}
...
// SetResults gets a reference to the given []ListingImagesResultsInner and assigns it to the Results field.
