...
type ShopProductionPartners struct {
	...
	Results []ShopProductionPartnersResultsInner `json:"results,omitempty"`
}
...
func (o *ShopProductionPartners) GetResults() []ShopProductionPartnersResultsInner {
	if o == nil || IsNil(o.Results) {
		var ret []ShopProductionPartnersResultsInner
		return ret
	}
	return o.Results
}
...
// SetResults gets a reference to the given []ShopProductionPartnersResultsInner and assigns it to the Results field.
