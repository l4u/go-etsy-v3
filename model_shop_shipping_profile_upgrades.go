...
type ShopShippingProfileUpgrades struct {
	...
	Results []ShopShippingProfileUpgradesResultsInner `json:"results,omitempty"`
}
...
func (o *ShopShippingProfileUpgrades) GetResults() []ShopShippingProfileUpgradesResultsInner {
	if o == nil || IsNil(o.Results) {
		var ret []ShopShippingProfileUpgradesResultsInner
		return ret
	}
	return o.Results
}
...
// SetResults gets a reference to the given []ShopShippingProfileUpgradesResultsInner and assigns it to the Results field.
