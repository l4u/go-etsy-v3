...
// checks if the ShopReceiptDiscountAmt type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShopReceiptDiscountAmt{}

// ShopReceiptDiscountAmt The numeric total discounted price for the receipt when using a discount (percent or fixed) coupon. Free shipping coupons are not included in this discount amount.
type ShopReceiptDiscountAmt struct {
...
func (o ShopReceiptDiscountAmt) MarshalJSON() ([]byte, error) {
...
func (o ShopReceiptDiscountAmt) ToMap() (map[string]interface{}, error) {
...
type NullableShopReceiptDiscountAmt struct {
	value *ShopReceiptDiscountAmt
	isSet bool
}

func (v NullableShopReceiptDiscountAmt) Get() *ShopReceiptDiscountAmt {
	return v.value
}

func (v *NullableShopReceiptDiscountAmt) Set(val *ShopReceiptDiscountAmt) {
	v.value = val
	v.isSet = true
}

func (v NullableShopReceiptDiscountAmt) IsSet() bool {
	return v.isSet
}

func (v *NullableShopReceiptDiscountAmt) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShopReceiptDiscountAmt(val *ShopReceiptDiscountAmt) *NullableShopReceiptDiscountAmt {
	return &NullableShopReceiptDiscountAmt{value: val, isSet: true}
}

func (v NullableShopReceiptDiscountAmt) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShopReceiptDiscountAmt) UnmarshalJSON(src []byte) error {
	v.isSet = true
