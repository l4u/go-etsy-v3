...
// checks if the SellerTaxonomyNodeChildrenInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SellerTaxonomyNodeChildrenInner{}

// SellerTaxonomyNodeChildrenInner An array of taxonomy nodes for all the direct children of this taxonomy node in the seller taxonomy tree.
type SellerTaxonomyNodeChildrenInner struct {
	...
	Children []SellerTaxonomyNodeChildrenInner `json:"children,omitempty"`
...
func NewSellerTaxonomyNodeChildrenInner() *SellerTaxonomyNodeChildrenInner {
	this := SellerTaxonomyNodeChildrenInner{}
	return &this
}
...
func (o *SellerTaxonomyNodeChildrenInner) SetParentIdNil() {
	o.ParentId.Set(nil)
}
...
func (o *SellerTaxonomyNodeChildrenInner) GetChildren() []SellerTaxonomyNodeChildrenInner {
	if o == nil || IsNil(o.Children) {
		var ret []SellerTaxonomyNodeChildrenInner
		return ret
	}
	return o.Children
}
...
// SetChildren gets a reference to the given []SellerTaxonomyNodeChildrenInner and assigns it to the Children field.
...
func (o SellerTaxonomyNodeChildrenInner) MarshalJSON() ([]byte, error) {
...
func (o SellerTaxonomyNodeChildrenInner) ToMap() (map[string]interface{}, error) {
...
type NullableSellerTaxonomyNodeChildrenInner struct {
	value *SellerTaxonomyNodeChildrenInner
	isSet bool
}

func (v NullableSellerTaxonomyNodeChildrenInner) Get() *SellerTaxonomyNodeChildrenInner {
	return v.value
}

func (v *NullableSellerTaxonomyNodeChildrenInner) Set(val *SellerTaxonomyNodeChildrenInner) {
	v.value = val
	v.isSet = true
}

func (v NullableSellerTaxonomyNodeChildrenInner) IsSet() bool {
	return v.isSet
}

func (v *NullableSellerTaxonomyNodeChildrenInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSellerTaxonomyNodeChildrenInner(val *SellerTaxonomyNodeChildrenInner) *NullableSellerTaxonomyNodeChildrenInner {
	return &NullableSellerTaxonomyNodeChildrenInner{value: val, isSet: true}
}

func (v NullableSellerTaxonomyNodeChildrenInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSellerTaxonomyNodeChildrenInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
