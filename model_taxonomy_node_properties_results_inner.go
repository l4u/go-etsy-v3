...
// checks if the TaxonomyNodePropertiesResultsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TaxonomyNodePropertiesResultsInner{}

// TaxonomyNodePropertiesResultsInner The list of requested resources.
type TaxonomyNodePropertiesResultsInner struct {
...
func NewTaxonomyNodePropertiesResultsInner() *TaxonomyNodePropertiesResultsInner {
	this := TaxonomyNodePropertiesResultsInner{}
	return &this
}
...
func (o *TaxonomyNodePropertiesResultsInner) SetMaxValuesAllowedNil() {
...
func (o TaxonomyNodePropertiesResultsInner) MarshalJSON() ([]byte, error) {
...
func (o TaxonomyNodePropertiesResultsInner) ToMap() (map[string]interface{}, error) {
...
type NullableTaxonomyNodePropertiesResultsInner struct {
	value *TaxonomyNodePropertiesResultsInner
	isSet bool
}

func (v NullableTaxonomyNodePropertiesResultsInner) Get() *TaxonomyNodePropertiesResultsInner {
	return v.value
}

func (v *NullableTaxonomyNodePropertiesResultsInner) Set(val *TaxonomyNodePropertiesResultsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableTaxonomyNodePropertiesResultsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableTaxonomyNodePropertiesResultsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTaxonomyNodePropertiesResultsInner(val *TaxonomyNodePropertiesResultsInner) *NullableTaxonomyNodePropertiesResultsInner {
	return &NullableTaxonomyNodePropertiesResultsInner{value: val, isSet: true}
}

func (v NullableTaxonomyNodePropertiesResultsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTaxonomyNodePropertiesResultsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
