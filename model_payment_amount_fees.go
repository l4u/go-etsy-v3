...
// checks if the PaymentAmountFees type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaymentAmountFees{}

// PaymentAmountFees An integer equal to the original card processing fee of the order in pennies.
type PaymentAmountFees struct {
...
func (o PaymentAmountFees) MarshalJSON() ([]byte, error) {
...
func (o PaymentAmountFees) ToMap() (map[string]interface{}, error) {
...
type NullablePaymentAmountFees struct {
	value *PaymentAmountFees
	isSet bool
}

func (v NullablePaymentAmountFees) Get() *PaymentAmountFees {
	return v.value
}

func (v *NullablePaymentAmountFees) Set(val *PaymentAmountFees) {
	v.value = val
	v.isSet = true
}

func (v NullablePaymentAmountFees) IsSet() bool {
	return v.isSet
}

func (v *NullablePaymentAmountFees) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaymentAmountFees(val *PaymentAmountFees) *NullablePaymentAmountFees {
	return &NullablePaymentAmountFees{value: val, isSet: true}
}

func (v NullablePaymentAmountFees) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaymentAmountFees) UnmarshalJSON(src []byte) error {
	v.isSet = true
