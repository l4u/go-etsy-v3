...
// checks if the ShopListingWithAssociationsInventory type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShopListingWithAssociationsInventory{}

// ShopListingWithAssociationsInventory An enumerated string that attaches a valid association. Default value is null.
type ShopListingWithAssociationsInventory struct {
...
func NewShopListingWithAssociationsInventory() *ShopListingWithAssociationsInventory {
	this := ShopListingWithAssociationsInventory{}
	return &this
}
...
func (o ShopListingWithAssociationsInventory) MarshalJSON() ([]byte, error) {
...
func (o ShopListingWithAssociationsInventory) ToMap() (map[string]interface{}, error) {
...
type NullableShopListingWithAssociationsInventory struct {
	value *ShopListingWithAssociationsInventory
	isSet bool
}

func (v NullableShopListingWithAssociationsInventory) Get() *ShopListingWithAssociationsInventory {
	return v.value
}

func (v *NullableShopListingWithAssociationsInventory) Set(val *ShopListingWithAssociationsInventory) {
	v.value = val
	v.isSet = true
}

func (v NullableShopListingWithAssociationsInventory) IsSet() bool {
	return v.isSet
}

func (v *NullableShopListingWithAssociationsInventory) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShopListingWithAssociationsInventory(val *ShopListingWithAssociationsInventory) *NullableShopListingWithAssociationsInventory {
	return &NullableShopListingWithAssociationsInventory{value: val, isSet: true}
}

func (v NullableShopListingWithAssociationsInventory) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShopListingWithAssociationsInventory) UnmarshalJSON(src []byte) error {
	v.isSet = true
